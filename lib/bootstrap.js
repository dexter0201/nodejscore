...
module.exports = function (options, NodeJsCore) {
    var app,
    ...
    for (var i in config.disabledModules) {
        disabled[config.disabledModules[i]] = true;
    }

    NodeJsCore.Singleton.Module.bootstrapModules(disabled);
