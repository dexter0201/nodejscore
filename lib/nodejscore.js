...
function doBootstrap(callback, err) {
    ...
    NodeJsCore.Singleton.config.loadSettings(function () {
        require('./bootstrap')(NodeJsCore, callback.bind(null, NodeJsCore.Singleton.app, NodeJsCore.Singleton.config.clean));
    });
}
...
NodeJsCore.prototype.runInstance = function (options, callback) {
    if (this.active) {
        return this;
    }
