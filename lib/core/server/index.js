...
function onInstance(NodeJsCore, nodejscoreInstance, defer) {
    NodeJsCore.prototype.runInstance = genericServer.bind(nodejscoreInstance, NodeJsCore);
...
function NamespaceServer(NodeJsCore) {
    NodeJsCore.onInstance(onInstance.bind(null, NodeJsCore));
}

module.exports = NamespaceServer;
