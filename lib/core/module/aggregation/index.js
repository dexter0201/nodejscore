...
function Aggregate(NodeJsCore) {
    ...
    NodeJsCore.prototype.aggregatedSrc = function (ext, group, callback) {
        ...
        if (ext === 'js') {
            callback(aggregated.js && aggregate.js[group] ? aggregated.js[group].getSrc() : []);
    ...
    NodeJsCore.prototype.aggregateAsset = function (type, asset,options) {
        options = options || {};
    ...
    NodeJsCore.prototype.aggregate = function(ext, asset, options, config) {
        if (!asset) {
            return false;
        }
